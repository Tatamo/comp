...
class Stage {
	...
	private array: Array<Array<string>>;
	private array_raw: Array<Array<string>>;
	score: number;
	constructor(array: Array<Array<string>>, h: number, w: number) {
		this.memory_size = 20;
	...
	move(dir: "U" | "D" | "L" | "R"): number {
		...
		if (result > 0) {
			if (this.array[this.current.y][this.current.x] === "o") this.score += 1;
